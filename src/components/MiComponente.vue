<template>
  <section id="content">
    ...
    <p class="alert-success-provisional" v-else-if="edad && edad >= 18">
      ¡¡ ERES MAYOR DE EDAD !!
    </p>
...
export default {
  ...
  data() {
    return {
      ...
      nombre: '',
      edad: 18, 
      peliculas: ['Batman vs Superman', 'El señor de los anillos', 'Spiderman', 'Annabelle']
    }
  }
}
</script>
